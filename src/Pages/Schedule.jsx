...
const Schedule = () => {
    ...
    piketGroup = [
        ["Bagus","Monik", "Fajar", "Farhan", "Gatar"],
        ["Adam","Dario","Hafidz","Jafar", "Raka"],
        ["Rochman","Naufal","Pandu","Raysa", "Jaki", "Eki", "Syafiq", "Viandra", "Zahra"],
        ["Abdurrahman", "Daffa", "Albian", "vino", "Arfan"],
        ["Hisan","Janis","Khalid", "Fahrie", "Abiyu", ],
    ]
